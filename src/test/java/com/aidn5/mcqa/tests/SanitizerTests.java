...
public class SanitizerTests {
	...
	public void test_with_various_one_word_inputs() {
		...
		// unicode char
		Assert.assertEquals("3 a", Sanitizer.sanitizeText(((char) ((123 << 8) + (244 << 0))) + "3 a", false));
	}
	...
	public void test_with_various_long_text_input() {
		Assert.assertEquals("abcdefghijklmnopqrstuvwxyz", Sanitizer.sanitizeText("abcdefghijklmnopqrstuvwxyz", true));
